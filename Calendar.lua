...
function M.new()
  ...
  local function refresh()
    ...
    m.api.UIDropDownMenu_SetText( month_dd, months[ set_month ] )
    m.api.UIDropDownMenu_SetText( year_dd, set_year )
  end
  ...
  local function create_date_button( parent, index )
    local button = m.api.CreateFrame( "Button", "EpochMailCalendarDay" .. index .. "Button", parent, "UIPanelButtonTemplate" )
    ...
    button:SetScript( "OnEnter", function( frame )
      m.api.GameTooltip:SetOwner( frame, "ANCHOR_RIGHT" )
  ...
  local function create_dropdown( parent, name, on_select )
    local dropdown = m.api.CreateFrame( "Frame", "EpochMailDropdown" .. name, parent, "UIDropDownMenuTemplate" )
    ...
    m.api.UIDropDownMenu_Initialize( dropdown, function()
      ...
      for i in pairs( valid_dates ) do
        ...
        info.func = function( index, value )
          m.api.UIDropDownMenu_SetText( dropdown, value )
  ...
  local function create_calendar()
    local frame = m.api.CreateFrame( "Frame", "EpochMailCalendarFrame" )
